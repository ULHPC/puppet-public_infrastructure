...
# Profiles Puppet Module Developments
...
### Directory Layout
       ...
       ulhpc-profiles/       # Main directory 
           ...
           `-- manifests/
                ...
                `-- classes/     # Hold manifest for ulhpc-profiles classes/
                     `-- ulhpc-profiles.pp         # defines the ulhpc-profiles class
                     `-- ulhpc-profiles-params.pp  # ulhpc-profiles module variables 
                `-- definitions/ # Hold manifest for ulhpc-profiles definitions
                     `-- ulhpc-profiles-mydef.pp   # defines the ulhpc-profiles::mydef definition   `-- templates/        # Module ERB template files
